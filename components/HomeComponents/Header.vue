  ...
  <div class="header relative text-white">
    ...
    >
      ...
      <div class="w-full flex justify-end">
        <CTA class="shadow-none hidden md:block" href="#tickets">BUY YOUR TICKET FOR AB 2023</CTA>
      </div>
      <div class="">
        <CTA class="shadow-none md:hidden" href="#tickets">BUY YOUR TICKET FOR AB 2023</CTA>
      </div>
    </RepeatingImage>
